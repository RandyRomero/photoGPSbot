...
lang_msgs = {
    'ru-RU': {
        ...
        'bad_gps': 'Не могу распознать формат GPS-данных.',
        ...
        'photos_from_country': 'Пользователей, которые тоже отправили фото из этой страны: ',
    ...
    'en-US': {
        ...
        'bad_gps': 'Cannot read GPS from this photo.',
